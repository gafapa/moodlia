...
export const ways: MoodliaWay[] = [
  {
    ...
    productSlugs: ["moodle-plugin", "cli", "moodle-core-cli", "sync", "skills"],
  },
  {
    slug: "teaching-tools",
    number: "2",
...
export const products: MoodliaProduct[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Offers explicit Core and plugin namespaces and machine-readable outcome codes",
      "Reads long HTML from UTF-8 files for every text field and streams large files",
  ...
  },
  {
    ...
    introduction:
      "A friendly client and command-line interface for Moodle 4.5 and later core web services. It turns complex REST details into stable operations without requiring the MoodlIA plugin.",
    highlights: [
      ...
      "Installs without native modules or other runtime dependencies",
  ...
  },
  {
    ...
    name: "MoodlIA Sync",
    waySlug: "ai-integration",
    kind: "Cross-site synchronization CLI",
    status: "Developer preview",
    description: "Copies reviewed course content between different Moodle sites without backup files.",
    introduction:
    ...
    startGuide: {
      ...
      adminNote: "MoodlIA Sync never uses Moodle backup files and never copies submissions, grades awarded, or logs.",
    },
    sourceUrl: "https://github.com/gafapa/moodlia-sync",
    sourceLabel: "View MoodlIA Sync on GitHub",
    secondaryUrl: "https://www.npmjs.com/package/moodlia-sync",
    secondaryLabel: "Open the npm package",
  },
  {
    slug: "skills",
