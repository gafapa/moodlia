...
- Creates a Moodle Lesson content, truefalse, shortanswer, multichoice, or numerical question page through `lesson_page::create(...)` after validating that the module belongs to the selected course.
...
- Context: Lesson module.
- Capabilities: `mod/lesson:manage`.
- Updates a Moodle Lesson content, truefalse, shortanswer, multichoice, or numerical question page through the Lesson page component `update(...)` method after verifying that the page belongs to the selected Lesson module.
