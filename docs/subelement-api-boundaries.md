...
- Workshop accumulative and comments grading form creation/replacement through Moodle Workshop grading strategy APIs, limited to setup phase and the active strategy.
...
- Workshop grading form strategies beyond accumulative and comments, and standalone assessment creation outside Moodle's allocation flow.
...
3. Additional Workshop grading form strategies beyond accumulative and comments, only after identifying stable subplugin APIs, payload schemas, and capability boundaries.
